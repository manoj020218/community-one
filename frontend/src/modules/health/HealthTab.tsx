...
/** Shared health display — used standalone at /health and as the "Health" tab on the Settings page. */
export function HealthTab() {
  ...
  if (isLoading) return <div className="card p-8 text-center text-slate-400">Loading health data...</div>;
  ...
  return (
    <>
      ...
      <div className="card p-4 text-center text-xs text-slate-400 mt-6">
